...
<div class="container-fluid">
    ...
    @endif
<button type="button" class="btn btn-primary" data-popover-content="#a1" data-container="body" data-toggle="popover" data-placement="bottom" >
    Applications
</button>
...
<div id="userchosenapplications" class="container">
    ...
    <div class="col-2">
        <a href="application/go/microsoft/{{$item->name}}">
